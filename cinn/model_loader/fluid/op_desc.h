...
using Attribute = variant<int, float, bool, std::vector<std::string>, std::vector<int>>;
...
class OpDesc {
 public:
  ...
  explicit OpDesc(framework::proto::OpDesc *desc) : desc_(desc) { CHECK(desc_); }
  ...
  std::vector<std::string> Input(const std::string &param) const { return GetArguments(desc_->inputs(), param); }

  std::vector<std::string> InputArgumentNames() const { return GetArgumentNames(desc_->inputs()); }

  void SetInput(const std::string &param, const std::vector<std::string> &args) {
    SetArgument(desc_->mutable_inputs(), param, args);
  }

  std::vector<std::string> Output(const std::string &param) const { return GetArguments(desc_->outputs(), param); }

  std::vector<std::string> OutputArgumentNames() const { return GetArgumentNames(desc_->outputs()); }

  void SetOutput(const std::string &param, const std::vector<std::string> &args) {
  ...
  bool HasAttr(const std::string &name) const {
    ...
    auto it =
        std::find_if(xs.begin(), xs.end(), [&](const framework::proto::OpDesc_Attr &x) { return x.name() == name; });
    return it != xs.end();
  }
...
#undef DEF_ONE
  ...
  std::vector<std::string> AttrNames() const {
    ...
    const auto &xs = desc_->attrs();
    std::transform(
        xs.begin(), xs.end(), std::back_inserter(res), [](const framework::proto::OpDesc_Attr &x) { return x.name(); });
    return res;
  }
 ...
 private:
  std::vector<std::string> GetArguments(const google::protobuf::RepeatedPtrField<framework::proto::OpDesc_Var> &xs,
                                        const std::string &param) const {
    std::vector<std::string> res;
    auto it = std::find_if(
        xs.begin(), xs.end(), [&](const framework::proto::OpDesc_Var &it) { return it.parameter() == param; });
    CHECK(it != xs.end());
  ...
  void SetArgument(google::protobuf::RepeatedPtrField<framework::proto::OpDesc_Var> *xs,
  ...
  std::vector<std::string> GetArgumentNames(
      const google::protobuf::RepeatedPtrField<framework::proto::OpDesc_Var> &xs) const {
    std::vector<std::string> res;
    std::transform(xs.begin(), xs.end(), std::back_inserter(res), [](const framework::proto::OpDesc_Var &x) {
      return x.parameter();
    });
    return res;
  }
